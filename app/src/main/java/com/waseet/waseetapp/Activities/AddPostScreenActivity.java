...
public class AddPostScreenActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private Button post;
    private Spinner type_spinner, category_spinner, subcategory_spinner, country_spinner, state_spinner, city_spinner;
...
//    }
    ...
    private void postAddNewAds() {
        if (ConfigurationData.uploadedImageF == null || ConfigurationData.uploadedImageF.isEmpty()) {
            ...
            ApiInterface apiInterface = ApiClients.getRetrofit().create(ApiInterface.class);
            Call<CommonResponse> responseCall = apiInterface.postAddNewAds(crsfToken, userId, categoryId, subCategoryId,
                    prices, adsNegotiable, country, state, city, addresss, addressLati, addressLongi, addTitle, adsTag,
                    addImageFirst, adsDescription);

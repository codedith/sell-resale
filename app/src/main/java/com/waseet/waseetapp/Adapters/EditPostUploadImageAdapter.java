...
public class EditPostUploadImageAdapter extends RecyclerView.Adapter<GridViewHolder> {

    private Context mContext;
    private List<ImageList> data;
    private AppPreferencesShared appPreferencesShared;

    public EditPostUploadImageAdapter(Context mContext, List<ImageList> data) {
